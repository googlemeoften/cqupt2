			...
			<div class="content-box">
				...
				<div class="content">
					<ol class="breadcrumb">
								...
								<li><a href="javascript:void(0)">教师列表</a></li>
					</ol>
							...
							<!--<div class="col-md-2">
								<div  class="thumbnail">
									<div class="restrictImg" >
							      		<img src="images/introteacher2.jpg" alt="" data-toggle="modal" data-target="#myModalTeacher" width="100px" height="140px">
							      	</div>
							      	<div class="caption">
							      		<h5>胡光辉</h5>
							      		<p>阿萨大苏打</p>
