			...
			<div class="content-box">
				...
				<div class="content">
					<ol class="breadcrumb">
								...
								<li><a href="javascript:void(0)">优秀学生</a></li>
					</ol>
					<div class="alert alert-info" role="alert">
					  <p style="text-align: center;">${msg }</p>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">优秀学生发布</div>
						<div class="panel-body">
							<form action="<c:url value='addPerson.action'/>" method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div class="form-group">
									<label class="control-label col-md-1">工作</label>
									<div class="col-sm-5">
								...
								<div class="form-group" style="display: none;">
									...
									<div class="col-sm-2">
									    <input type="text" name="person_state" class="form-control" value="1"/>
									</div>
								</div>
